...
pi = autovettori[:,0] # l'autovettore non è stocastico

# normalizzazione autovettore legato a lambda = 1 rispetto alla somma degli elementi

pi = autovettori[:,0]/sum(autovettori[:,0])
